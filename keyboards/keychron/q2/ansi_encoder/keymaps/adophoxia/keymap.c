...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [WIN_BASE] = LAYOUT_ansi_67(
        ...
        KC_LCTL, KC_LWIN, KC_LALT,                            KC_SPC,                             KC_RALT, MO(WIN_FN), MO(WIN_MM), KC_LEFT, KC_DOWN, KC_RGHT),

    [WIN_FN] = LAYOUT_ansi_67(
        KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,   KC_F12,   _______,          ENC_PRS,
    ...
    [WIN_MM] = LAYOUT_ansi_67(
        ...
        CTL_GRV, _______, _______,                            _______,                            _______, KC_TRNS,  KC_TRNS,  _______, _______, _______)
};